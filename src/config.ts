...
export const M2_VOTE = {
  ...
  questions: [
    ...
    {
      level: 2,
      msg: '생활관 청소 안 한 호실 지금 조사 중이다',
      q: '당신은 청소를 했다.\n올바른 답변을 골라라',
      corrects: [
        '청소를 하지 않았다는 것은 사실이 아닙니다',
        '청소를 하지 않은 것이 아닙니다',
        '청소를 안 했다고 말할 수 없습니다',
      ],
      wrongs: [
        '청소를 하지 않았다는 것을 부정하기 어렵습니다',
        '청소를 했다고 말할 수는 없습니다',
        '청소를 안 한 것이 아니라고 하기는 어렵습니다',
      ],
    },
    {
      level: 2,
      msg: '군가 가사 못 외운 인원은 오늘 남아라',
      q: '당신은 가사를 다 외웠다.\n올바른 답변을 골라라',
      corrects: [
        '외우지 못했다고 하기는 어렵습니다',
        '못 외웠다는 것은 사실이 아닙니다',
      ...
      wrongs: [
        '외웠다고 하기는 어렵습니다',
        '못 외웠다는 것을 부정할 수 없습니다',
        '외우지 못한 것이 아니라고 하기는 어렵습니다',
      ],
    },
    {
      level: 2,
      msg: '아침 점호 지각자 명단 다시 뽑는다',
      q: '당신은 지각하지 않았다.\n올바른 답변을 골라라',
      corrects: [
        '지각했다고 볼 수 없습니다',
        '지각하지 않았다는 것은 거짓이 아닙니다',
        '지각했다는 것은 사실이 아닙니다',
      ],
      wrongs: [
        '지각을 안 했다고 볼 수는 없습니다',
        '지각하지 않은 것이 아닙니다',
        '지각했다는 것을 부정하기는 어렵습니다',
      ],
    },
    {
      level: 3,
      msg: '이번 주 벌점자 수합해서 올려라',
      q: '당신은 벌점을 받은 적이 없다.\n올바른 답변을 골라라',
      corrects: [
        '벌점을 받았다는 것이 사실이라고 할 수 없습니다',
        '벌점을 받지 않았음을 부정할 수 없습니다',
        '벌점을 받지 않았다는 것은 사실이 아닌 것이 아닙니다',
      ],
      wrongs: [
        '벌점을 받지 않은 적이 없습니다',
        '벌점을 안 받았다고 하면 거짓입니다',
        '벌점을 받았다는 것을 부정할 수 없지 않은 것은 아닙니다',
      ],
    },
    {
      level: 3,
      msg: '소등 후 샤워장에서 노랫소리 들렸다는데?',
      q: '당신은 부른 적이 없다(고 하자).\n올바른 답변을 골라라',
      corrects: [
        '제가 불렀다는 주장이 거짓이 아니라고 할 수 없습니다',
        '부르지 않았다는 것을 부정할 수 없습니다',
        '불렀다는 것이 사실이 아니지 않다고 할 수 없습니다',
      ],
      wrongs: [
        '부르지 않았다고 하면 거짓이 아닌 것이 아닙니다',
        '불렀다는 것을 부정하기는 어렵습니다',
        '부르지 않은 것이 아님을 인정합니다',
      ],
    },
